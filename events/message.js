                 ...
                 user.id !== message.author.id &&
                  ...
                  if(chosen === "🗑️"){
                    ...
                    const warnerr = new Discord.MessageEmbed()
                      .setTitle('Erreur')
                      .setColor('#FF0000')
                      .setDescription(`❌ Une erreur s'est produite pendant la tentaive d'ajout d'un avertissement' !`)
                      .setFooter('© BMO', client.user.avatarURL)
                      .setTimestamp();
                    ...
                    const stop = new Discord.MessageEmbed()
                      .setTitle('Ignorer')
                      .setColor('#FF0000')
                      .setDescription(`❌ Aucune action n'a été effectué pour l'utilisateur <@`+author+`> !`)
                      .addField("Contenu du message :", message.content.substr(0))
                      .setFooter('© BMO', client.user.avatarURL)
                      .setTimestamp();
